...
class AetherisLocalBrain {
  static Future<String> answer(String rawQuestion) async {
    ...
    if (!q.contains('farmacia') && _any(q, ['medicamento', 'medicina', 'pastilla', 'droga', 'fármaco', 'farmaco'])) {
      AppLogger.debug('[DEBUG local_brain] MEDICAMENTO match! q="$q"');
    ...
    // ── APICULTURA / ABEJAS / MIEL ─────────────────────────────────────────
    if (_any(q, ['apicultura', 'apícola', 'apicola', 'abejas', 'abeja', 'colmena', 'colmenas',
        'miel', 'panal', 'apicultor', 'enjambre', 'enjambrazón', 'enjambrazon',
        'polinización', 'polinizacion', 'jalea real', 'propóleo', 'propoleo', 'cera de abeja',
        'abeja reina', 'zángano', 'zangano'])) {
      return 'La apicultura es la crianza de abejas para obtener miel, polen, propóleo, jalea real '
          'y cera, y para polinizar cultivos. En Panamá se practica principalmente con Apis mellifera '
          'en Chiriquí (Boquete, Volcán, Renacimiento), Veraguas y Panamá Oeste. Una colonia produce '
          '20-40 kg de miel al año. Paneles básicos: ahumador (con hojas secas), traje con velo, '
          'guantes, espátula apícola y cepillo desabejador. Para empezar, contacta apicultores locales '
          'o al MIDA/DINASA. Para más detalle, pregunta por "qué es apicultura", "tipos de abejas", '
          '"cómo se produce la miel", "colmena langstroth", "equipo apícola", "abeja reina" o "polinización".';
    }
  ...
  /// Ver [KnowledgeDomainService._any]: claves con espacios se buscan como
  /// substring, palabras únicas requieren palabra completa.
