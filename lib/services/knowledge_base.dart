class KnowledgeBase {
  ...
  static const _entries = <_Entry>[
    ...
    _Entry(['medicamentos comunes', 'medicinas básicas'], 'Medicamentos comunes de venta libre: paracetamol (fiebre/dolor), ibuprofeno (antiinflamatorio), loratadina (alergias), omeprazol (acidez), ibuprofeno (dolor muscular), antidiarreicos (loperamida). Siempre consulta al médico o farmacéutico.'),
    ...
    _Entry(['farmacia metro', 'farmacias metro', 'metro farmacia', 'metro farmacias'], 'Farmacias Metro es la cadena de farmacias más grande de Panamá, con más de 100 sucursales en todo el país. En la Ciudad de Panamá: Vía España (24h), El Dorado (24h), Albrook Mall, Los Pueblos, Costa del Este, San Miguelito, Juan Díaz, Bethania, Pueblo Nuevo, Parque Lefevre, San Francisco. En Chiriquí: David (Vía Interamericana, Calle Central, Terminal), Bugaba (La Concepción), Volcán. En Panamá Oeste: La Chorrera, Arraiján. En Veraguas: Santiago. En Coclé: Penonomé. En Herrera: Chitré. En Colón: Colón. Horario típico: 7am a 9pm, algunas 24h.'),
    ...
    _Entry(['farmacia arrocha', 'farmacias arrocha', 'arrocha farmacia', 'arrocha farmacias'], 'Farmacias Arrocha es una cadena de farmacias en Panamá con sucursales en: Multiplaza Pacific (San Francisco), Vía Argentina, San Francisco (Calle 50), Costa del Este, Bugaba (La Concepción), David (Vía Interamericana, Plaza Terronal). Horario: lunes a sábado 8am a 9pm, domingo 9am a 7pm. Ofrecen servicio a domicilio.'),
