class KnowledgeBase {
  ...
  static const _entries = <_Entry>[
    ...
    // ── FARMACIAS ──────────────────────────────────────────────────────────
    _Entry(['farmacias en panamá', 'farmacias panamá', 'mejores farmacias panamá'], 'Principales farmacias en Panamá: Farmacias Metro (múltiples sucursales, servicio 24h en algunas), Farmacias Arrocha (varias sucursales), Farmacias El Rey (dentro de supermercados Rey), Farmacias Súper 99 (dentro de supermercados Súper 99), Farmacias del Machetazo (dentro de El Machetazo), Farmacias Xtra (dentro de Xtra). Muchas farmacias ofrecen servicio a domicilio y entrega gratuita en la Ciudad de Panamá.'),
    _Entry(['farmacia 24 horas panamá', 'farmacia de turno panamá', 'farmacia abierta ahora'], 'Farmacias 24 horas en Panamá: Algunas sucursales de Farmacias Metro operan 24h (Meto Park, Vía España, El Dorado). Farmacias Arrocha en Multiplaza Pacific cierra a las 10pm. Para encontrar una farmacia de turno cerca usa Google Maps. Muchas farmacias en la Ciudad de Panamá abren hasta las 10pm. Las farmacias en hospitales (Santo Tomás, Punta Pacífica, San Fernando) suelen tener horario extendido.'),
